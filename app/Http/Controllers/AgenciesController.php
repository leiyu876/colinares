...
class AgenciesController extends Controller
{
    ...
    public function index()
    {
    	...
    	dd($texts_final);
    	$homepage = file_get_contents('http://www.poea.gov.ph/cgi-bin/agList.asp?mode=all');
    	preg_match_all('|<p>(.*?)</p>|',$homepage,$Output);
dd($Output);
exit;
    	/*
    	ini_set('max_execution_time', 300);
    	
    	$text = file_get_contents("http://www.poea.gov.ph/cgi-bin/agList.asp?mode=all");
		...
		*/
		...
		$data = array(
    		'name'=>'Princess Virtucio [princess.virtucio@yahoo.com]',
    		'email'=>'support@virneza.com',
    		'subject'=>'applicant1',
    		'bodymessage'=>'applicant message1',
    	);
    	...
    	*/
        ...
        return view('agencyemail.index', $data);
    }
