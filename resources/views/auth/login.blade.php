...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('auth/plugins/iCheck/square/blue.css') }}">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="{{ route('login') }}" method="post">
      ...
      <div class="row">
        <div class="col-xs-4">    
          <a href="{{ url('/') }}" class="btn btn-default btn-block btn-flat">Cancel</a>    
        </div>
        <!-- /.col -->
...
<!-- iCheck -->
<script src="{{ asset('auth/plugins/iCheck/icheck.min.js') }}"></script>
<script>
  $(function () {
    $('input').iCheck({
